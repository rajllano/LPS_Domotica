    ...
    public static class ControlDispostivos
    {
        ...
        public static Respuesta Agregar(string pIdDispostivo, string pIdUsuaurio, string pNombre, ETipoDispositivo pTipo, EEstadoDispositivo pEstado, Double pValor)
        {
            ...
            try
            {
                ...
                Dispositivo d = Domotica.getInstancia().ColeccionDispositivo.BuscarPorId(pIdDispostivo);
                ...
                Domotica.getInstancia().ColeccionDispositivo.Agregar(d);
        ...
        public static Respuesta EliminarPorId(string pId)
        {
            ...
            try
            {
                Dispositivo d = Domotica.getInstancia().ColeccionDispositivo.BuscarPorId(pId);
        ...
        public static Respuesta Listar()
        {
            ...
            try
            {
                ColeccionDispositivo cd = Domotica.getInstancia().ColeccionDispositivo;
